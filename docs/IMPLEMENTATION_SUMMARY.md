...
- Production MoveNet ONNX adapter with ONNX Runtime CPU execution and pinned downloader; controlled OpenCV fiducial adapter only for deterministic verification.
...
- Full benchmark evaluation against labeled clinical or sports-science ground truth
